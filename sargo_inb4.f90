...
integer:: n, i, k, maxgen, c, nb_anim, nex, c1, c2, ndad, nmum
...
print *, '             ... done'
print *, '--------------------------------------------------------------'
print '(a)', '  PGEN  #ANIMS #SIRES   #DAMS    #ANCS     AVGINB[%]   TIME[s]'
...
do k=3, maxgen
        ...
        call cpu_time(t22)
        print '(i5,i9,i7,i8,i9,1x,2f10.2)', k-1, nb_anim,  ndad, nmum, nex, 100*tot_inb/real(nb_anim), t22-t11
enddo
print *, '--------------------------------------------------------------'
