...
integer:: n, i, k, maxgen, npar, c, nb_anim, nex
...
print *, '             ... done'
print *, '---------------------------------------------------------------------'
print '(a)', '  PSEUDO-GEN   #ANIMALS   #PARENTS #EXTRACTED AVG_INBREEDING TIME[MIN]'
...
do k=3, maxgen
        ...
        call cpu_time(t22)
        print '(4i11,f12.4,f12.2)', k-1, nb_anim,  npar, nex, tot_inb/real(nb_anim), (t22-t11)/60
enddo
print *, '----------------------------------------------------------------------'
